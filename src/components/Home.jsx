...
//                 <label
//                   htmlFor="image_url"
//                   className="flex justify-center bg-zinc-300 col-start-1 col-span-1 sm:col-span-2 mt-4 p-3 rounded-md sm:p-3 font-semibold"
//                 >
//                   <input
//                     type="file"
//                     id="image_url"
...
// export default Home;
  ...
  function Home() {
    const [loading, setLoading] = useState(true);
    const [formSubmitted, setFormSubmitted] = useState(true); // Track submission status
